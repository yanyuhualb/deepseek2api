...
export const config = Object.freeze({
  ...
  overflowUploadEnabled: (process.env.OVERFLOW_UPLOAD_ENABLED ?? "true") !== "false",
  overflowUploadTimeoutMs: Number(process.env.OVERFLOW_UPLOAD_TIMEOUT_MS ?? 30000),
  overflowUploadPollIntervalMs: Number(process.env.OVERFLOW_UPLOAD_POLL_INTERVAL_MS ?? 1500),
